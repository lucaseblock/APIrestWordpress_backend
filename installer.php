...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'wordpressapirest_paquete_d9a3388893e183566236_20200624003414_archive.zip';
	const ARCHIVE_SIZE		 = '25862476';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'd9a3388-24003414';
    const SECONDARY_PACKAGE_HASH = '993d2d4-24003414';
